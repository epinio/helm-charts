...
{{/*
Enable/disable Gateway API HTTPs Listener Redirect
*/}}
{{- define "epinio-enable-https-redirect" -}}
{{- dig "httpsRedirect" false (.Values.userConfig | default dict) | ternary true false }}
{{- end }}
